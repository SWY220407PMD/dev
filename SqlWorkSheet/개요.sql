...
/*
    ...
    데이터 조작 언어
    EX ) SELECT , ISNERT, UPDATE, DELETE
*/
-- DCL
/*
...
/*
    ...
    NCHAR(SIZE)
    EX ) NCHAR(10) : 10글자 까지 담을 수 있는 문자열 칼럼 생성 (상황에 따라 힌 글자당 2 || 3 바이트로 처리됨)
*/
...
/*
    ...
    NUMBER(10, -5): 소수점 -5 자리에서 반올림하는 최대 10자리 숫자
*/
